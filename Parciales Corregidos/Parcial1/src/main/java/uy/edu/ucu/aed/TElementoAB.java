...
public class TElementoAB<T> implements IElementoAB<T> {
    ...
    public void obtenerListas (Lista lista1, Lista lista2){
        if(this.hijoIzq == null && this.hijoDer == null){
            lista1.insertar(this.etiqueta, this.datos);
        } else {
            lista2.insertar(this.etiqueta, this.datos);
        }

        if(this.hijoIzq != null){
            this.hijoIzq.obtenerListas(lista1, lista2);
        }

        if(this.hijoDer != null){
            this.hijoDer.obtenerListas(lista1, lista2);
        }
