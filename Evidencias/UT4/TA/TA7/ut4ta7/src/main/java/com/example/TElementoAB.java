...
public class TElementoAB<T> implements IElementoAB{
    ...
    public boolean encuentraLineal(String nombreAtributo, Comparable valorAtributo) {
        ...
        try {
            atributo = this.dato.getClass().getDeclaredField(nombreAtributo);
            atributo.setAccessible(true);
            Object value = atributo.get(this.dato);
            if(value != null && value.equals(valorAtributo)){
                return true;
            }
            if (this.hijoIzq != null) {
                return this.hijoIzq.encuentraLineal(nombreAtributo, valorAtributo);
            }
            if (this.hijoDer != null) {
                return this.hijoDer.encuentraLineal(nombreAtributo, valorAtributo);
            }
            return false;
